...
author: JerryI
description: You've likely seen videos featuring animated bar charts with a timeline, where the bars dynamically shift and overtake each other. Here is a snippet for that
tags:
  - animation
date: 2024-09-11
---
...
The animation is pure based on transitions interpolation of `Graphics` expression and is regularted via `Directive`.
