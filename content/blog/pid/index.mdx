...
Of course, in this case $u(t)$ cannot be negative and is clamped to the maximum water flow we can have in the system. Even here, the main idea is clear: *we measure the deviation from the goal and act on the system so that this deviation decreases*.
