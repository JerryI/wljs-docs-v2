...
<Tabs items={['Windows', 'Mac','GNU/Linux', 'Docker', 'Homebrew']}>
  <Tab value="Mac">
    - [Apple Silicon](https://github.com/WLJSTeam/wolfram-js-frontend/releases/download/v2.8.8/wljs-notebook-2.8.8-arm64-macos.dmg)
    - [Intel](https://github.com/WLJSTeam/wolfram-js-frontend/releases/download/v2.8.8/wljs-notebook-2.8.8-x64-macos.dmg)
  </Tab>
  <Tab value="Windows">
    - [x86/64](https://github.com/WLJSTeam/wolfram-js-frontend/releases/download/v2.8.8/wljs-notebook-2.8.8-x64-win.exe)
  </Tab>
  <Tab value="GNU/Linux">
    - [DEB x86/64](https://github.com/WLJSTeam/wolfram-js-frontend/releases/download/v2.8.8/wljs-notebook-2.8.8-amd64-gnulinux.deb)
    - [DEB ARM64](https://github.com/WLJSTeam/wolfram-js-frontend/releases/download/v2.8.8/wljs-notebook-2.8.8-arm64-gnulinux.deb)
    - [AppImage x86/64](https://github.com/WLJSTeam/wolfram-js-frontend/releases/download/v2.8.8/wljs-notebook-2.8.8-x86_64-gnulinux.AppImage)
    - [AppImage ARM64](https://github.com/WLJSTeam/wolfram-js-frontend/releases/download/v2.8.8/wljs-notebook-2.8.8-arm64-gnulinux.AppImage)
  </Tab>
  <Tab value="Docker">
