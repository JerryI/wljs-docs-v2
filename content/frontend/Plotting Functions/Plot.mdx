...
### `Controls` 💛
This is more an option for [Graphics](../Graphics/Graphics), but with a bit of a hacking it can be used here as well. The features __allows to pan and zoom your plots__, that was never possible in Mathematica
