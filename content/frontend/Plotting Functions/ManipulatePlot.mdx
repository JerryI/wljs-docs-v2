...
a dynamic alternative to [Plot](../Plotting%20Functions/Plot) and Mathematica's [Manipulate](../GUI/Manipulate), that uses input elements and [Offload](../Interpreter/Offload) technic to make a fast interactive plots of a given function `f[t, p1, p2...]` 
...
## Portability
It can be automatically exported to [Interactive HTML](frontend/Exporting/Interactive%20HTML) or [MDX](frontend/Exporting/MDX) in __automatic mode__.
