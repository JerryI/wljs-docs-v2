...
an interactive alternative to [Plot](../Plotting%20Functions/Plot) and Mathematica's [Manipulate](../GUI/Manipulate), that uses input elements and [Offload](../Interpreter/Offload) technic to make a fast interactive plots of a given function `f[t, p1, p2...]` 
