...
```wolfram
NSolve[Sin[x] == 0, x, MaxRoots -> 5]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/MaxRoots.html) for more details.*