...
```wolfram
task = RunScheduledTask[Print[DateString[]], 5]
```
...
*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/RunScheduledTask.html) for more details.*