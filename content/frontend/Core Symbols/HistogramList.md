...
```wolfram
HistogramList[{1, 2, 2, 3, 3, 3, 4, 4, 5}]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/HistogramList.html) for more details.*