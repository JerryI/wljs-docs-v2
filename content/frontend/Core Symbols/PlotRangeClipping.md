...
```wolfram
Plot[Tan[x], {x, 0, 2 Pi}, PlotRangeClipping -> True]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/PlotRangeClipping.html) for more details.*