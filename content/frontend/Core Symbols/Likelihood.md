...
```wolfram
Likelihood[NormalDistribution[μ, σ], {1, 2, 3}]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/Likelihood.html) for more details.*