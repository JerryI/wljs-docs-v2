...
```wolfram
PlanetaryMoonData["Europa", "Mass"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/PlanetaryMoonData.html) for more details.*