...
```wolfram
WikidataData["Q42", "occupation"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/WikidataData.html) for more details.*