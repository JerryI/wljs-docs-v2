...
```wolfram
Grid[{{Item["text", Background -> LightBlue], 2}, {3, 4}}]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/Item.html) for more details.*