...
### `"CounterClass"`
A text string of CSS classes applied to the numerical counter element

### `"CounterStyle"`
An inline CSS style string applied to the numerical counter element

### `"SliderClass"`
A text string of CSS classes applied to the slider element

### `"SliderStyle"`
An inline CSS style string applied to the slider element
