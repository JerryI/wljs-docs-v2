...
`CellView` supports [complete cell objects](./../Advanced/Notebook-Operations) representation as an input:
...
CellView[Cell[expr_String, "Output", "markdown"]]
```
...
- `"markdown"` a renderer of [Markdown](./../Cell-types/Markdown) cells
- `"html"` a renderer of [HTML](./../Cell-types/HTML)
- `"js"` a renderer of [Javascript](./../Cell-types/Javascript) cells
- `"mermaid"` a renderer of [Mermaid Diagrams](./../Cell-types/Misc)
- ...
