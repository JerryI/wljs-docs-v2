...
<Callout type="tip">
Consider also [ManipulatePlot](../Plotting%20Functions/ManipulatePlot) and [ManipulateParametricPlot](../Plotting%20Functions/ManipulateParametricPlot) for basic interactive curve plotting.
</Callout>
...
Here are a few examples with [Plot](../Plotting%20Functions/Plot) expressions that effectively use JIT:
