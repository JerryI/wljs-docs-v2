...
## Portability
The same as for [Animate](../GUI/Animate). `Manipulate` widgets can be exported to [Interactive HTML](frontend/Exporting/Interactive%20HTML) or [MDX](frontend/Exporting/MDX) in __automatic mode__.
