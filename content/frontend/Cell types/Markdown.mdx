...
<Callout info="idea">
Hide input cells using __cell group properties__ - see [Overview](./../Overview.mdx)
</Callout>
...
### Page breaks
For printing exported PDF or [Static HTML](frontend/Exporting/Static%20HTML.md) it comes handy to control page breaks manually. Use:
- `PageBreakAbove`
- `PageBreakBelow`
...
If you don't want to escape Markdown commands in your LaTeX code, please, consider to use [LaTeX](./Misc.mdx) cell type
...
## WLX
Markdown cells support many features of [WLX](./WLX.mdx) cells
