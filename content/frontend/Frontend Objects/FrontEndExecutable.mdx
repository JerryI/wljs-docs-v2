...
A static reference to a frontend object (see [CreateFrontEndObject](../Frontend%20Objects/CreateFrontEndObject))  like [FrontEndRef](../Frontend%20Objects/FrontEndRef), but can only be executed on the frontend (WLJS Interpreter).
