...
```wolfram
CirculantGraph[8, {1, 3}]
```

Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/CirculantGraph.html) for more details.