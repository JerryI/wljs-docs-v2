...
## Dynamics
It fully supports dynamics, but in a different way compared to other functions. Please see for that [PlotlyAddTraces](../Plotly/PlotlyAddTraces), [PlotlyAnimate](../Plotly/PlotlyAnimate) and etc.
