...
mimics the behavior of a native [Plot](../Plotting%20Functions/Plot) using a well-known [PlotlyJS](https://plotly.com/javascript/) library. It is quite limited and __does not support options__.
