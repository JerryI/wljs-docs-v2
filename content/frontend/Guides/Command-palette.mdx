...
| Command                                     | Description                                          |
| ------------------------------------------- | ---------------------------------------------------- |
| `wljs help`                                 | Show human-readable help.                            |
| `wljs help --json`                          | Show machine-readable command information.           |
| `wljs describe`                             | Print a JSON manifest for LLM agents and automation. |
| `wljs version`, `wljs -v`, `wljs --version` | Print CLI version.                                   |
| `wljs config`                               | Print runtime configuration.                         |
| `wljs status`                               | Check whether the local WLJS backend is reachable.   |
