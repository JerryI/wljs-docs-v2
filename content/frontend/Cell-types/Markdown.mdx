---
title: Markdown
description: Write narrative notebook content with WLJS Markdown cells, including formatted text, equations, images, links, drawings, and embedded web content.
---
...
Markdown is the main language for textual (narrative) cells in WLJS Notebook. Markdown cells inherit features of [WLX](./WLX) and [HTML](./HTML) cells.
...
Calculate something on-spot using [ToExpression](./../Programming-Constructs/ToExpression):

<WLJSWrapper>
<div className="code-input"/>
<wljs-editor type="Input" display="codemirror">{`.md
So far so good. The error is around <ToExpression>0.6 180/Pi</ToExpression>
`}</wljs-editor>
</WLJSWrapper>
