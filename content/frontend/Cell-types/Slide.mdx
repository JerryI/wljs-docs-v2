---
title: Slide
description: Create interactive WLJS presentations with Markdown slide cells, WLX and HTML content, events, fragments, fullscreen viewing, and PDF export.
---
...
<Accordions>
<Accordion title="Demonstration 1">

<LazyAutoplayVideo className={' '} url={"/ppt-dpg.mp4"}/>

</Accordion>
<Accordion title="Demonstration 2">
...
## Embedding any WL expression
To display Wolfram expression as in the normal output cell, you can force `StandardForm` on it:
