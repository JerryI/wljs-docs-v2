---
title: HTTP API
description: Use the WLJS HTTP API to manage notebooks and cells, evaluate Wolfram Language code, query kernels, and monitor asynchronous operations programmatically.
---
