---
title: Architecture
description: Explore WLJS Notebook architecture, including its Wolfram Engine processes, WebSocket communication, browser interpreter, notebook model, and extension system.
---


![](./imgs/Pasted-image-20250210130401-7170ae332f32e0f49b05f6a6eb4866eb.png)

WLJS Notebook is an application built on top of the Wolfram Engine (a freeware distribution of Wolfram Language) with a web-based GUI. Naturally, we isolate evaluation to a separate process of the Wolfram Engine connected via 2 shared-memory channels (main control link and async link), similar to Mathematica or Jupyter. Both can directly interact with the content rendered on the page directly using 2 binary WebSockets for the sake of performance and low-latency.
