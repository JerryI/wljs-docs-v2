...
<Callout>
A template repository is available at Github [wljs-plugin-template](https://github.com/WLJSTeam/wljs-plugin-template)
</Callout>
...
```json title="package.json"
{
  ...
  "wljs-meta": {
    ...
    "electron": "dist/electron/" | Array<string>, //loaded to NodeJS process as CommonJS module
