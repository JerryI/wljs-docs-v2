...
A wrapper that can be used for [`Text`](../Graphics/Text) . The following options can be provided
...
See more examples @ [Text](../Graphics/Text)

<Callout type="note">
See also [Style](../Formatting/Style) as decoration
</Callout>