...
<Callout type="info">
This has to be called inside the instance of [Graphics](../Graphics/Graphics) using [FrontSubmit](../Frontend%20IO/FrontSubmit)
</Callout>

*All transition effects are applied here as well*

## Example
Let us make a simple plot and reference it using [FrontInstanceReference](../Frontend%20IO/FrontInstanceReference)
