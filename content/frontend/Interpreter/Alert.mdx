...
## Example
This is purely WLJS function, which has to be called either using [FrontSubmit](../Frontend%20IO/FrontSubmit) or [CreateFrontEndObject](../Frontend%20Objects/CreateFrontEndObject)
