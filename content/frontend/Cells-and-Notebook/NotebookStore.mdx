...
<Callout type="warn">
Be aware of a __evaluation context loss__, use [EvaluationNotebook](../Cells-and-Notebook/EvaluationNotebook) for such cases if it is called from an external handler, i.e.
