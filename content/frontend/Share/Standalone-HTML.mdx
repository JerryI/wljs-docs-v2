...
Local images are embedded automatically, `NotebookStore[]` is preserved, and [embedded files](./Embed-Notebook-Files) are included. You can open the HTML file locally or [publish it as a webpage](./Deploy-to-Github-Pages).
