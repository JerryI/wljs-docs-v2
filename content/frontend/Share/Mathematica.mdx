---
title: Mathematica
description: Export WLJS notebooks to Mathematica .nb files or import Mathematica notebooks into WLJS, with guidance on supported content and limitations.
---
