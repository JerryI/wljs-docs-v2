...
<Callout type="idea">Use [WLX cells](./../Cell%20types/WLX.mdx) for maximum customization</Callout>

<Callout type="idea">You can create new windows with `CellPrint`</Callout>

## How to Prepare a Mini App
In general, you can think of a mini app as if it were an output of a single cell [projected](./../Overview.mdx) (see <small>Project</small> feature) to a window. The following rules apply:
