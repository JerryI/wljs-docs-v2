---
title: Mini apps
description: Turn a WLJS notebook into a standalone mini app with a dedicated window, automatic initialization, and interactive Wolfram Language interfaces.
---
