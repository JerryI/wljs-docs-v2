...
description: Publish interactive WLJS notebook HTML exports on GitHub Pages without a build step, and make them available as shareable web pages.
---
...
## Exporting
We assume you have exported your notebook to a [standalone HTML file](./Standalone-HTML):
