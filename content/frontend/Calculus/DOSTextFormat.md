...
```wolfram
OpenRead["file.txt", DOSTextFormat -> True]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/DOSTextFormat.html) for more details.*