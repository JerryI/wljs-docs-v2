...
Display a dodecahedron:

```wolfram
Graphics3D[Dodecahedron[]]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/Dodecahedron.html) for more details.*