...
```wolfram
Graphics[DiskSegment[{0, 0}, 1, {0, Pi/2}]]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/DiskSegment.html) for more details.*