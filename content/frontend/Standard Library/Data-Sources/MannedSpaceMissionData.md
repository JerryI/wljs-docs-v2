...
```wolfram
MannedSpaceMissionData["Apollo11", "LaunchDate"]
```

```wolfram
MannedSpaceMissionData["Apollo11", "Crew"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/MannedSpaceMissionData.html) for more details.*