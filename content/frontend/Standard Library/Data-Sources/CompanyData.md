...
```wolfram
CompanyData["Apple", "MarketCapitalization"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/CompanyData.html) for more details.*