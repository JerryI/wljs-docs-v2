...
Get data about a university:

```wolfram
UniversityData["MIT", "Location"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/UniversityData.html) for more details.*