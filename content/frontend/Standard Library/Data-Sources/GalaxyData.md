...
```wolfram
GalaxyData["MilkyWay", "Properties"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/GalaxyData.html) for more details.*