...
```wolfram
ParticleData["Proton", "Charge"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/ParticleData.html) for more details.*