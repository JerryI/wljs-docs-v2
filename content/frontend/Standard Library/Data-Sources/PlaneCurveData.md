...
```wolfram
PlaneCurveData["Cardioid", "Equation"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/PlaneCurveData.html) for more details.*