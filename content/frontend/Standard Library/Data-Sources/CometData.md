...
Get properties of Halley's Comet:

```wolfram
CometData["Halley", "OrbitalPeriod"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/CometData.html) for more details.*