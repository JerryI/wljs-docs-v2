...
```wolfram
ZIPCodeData["10001", "Population"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/ZIPCodeData.html) for more details.*