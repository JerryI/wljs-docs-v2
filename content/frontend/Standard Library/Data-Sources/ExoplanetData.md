...
```wolfram
ExoplanetData["Proxima Centauri b", "Mass"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/ExoplanetData.html) for more details.*