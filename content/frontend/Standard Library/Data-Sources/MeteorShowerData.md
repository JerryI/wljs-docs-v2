...
```wolfram
MeteorShowerData["Perseids", "PeakDate"]
```

```wolfram
MeteorShowerData["Leonids", "ZenithHourlyRate"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/MeteorShowerData.html) for more details.*