...
Get impact crater information:

```wolfram
EarthImpactData["Chicxulub", "Diameter"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/EarthImpactData.html) for more details.*