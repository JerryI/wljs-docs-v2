...
Specify a numeric array type:

```wolfram
LibraryDataType[NumericArray, "Real64", 2]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/LibraryDataType.html) for more details.*