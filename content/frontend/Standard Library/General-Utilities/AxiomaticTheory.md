...
Get group theory axioms:

```wolfram
AxiomaticTheory["GroupAxioms"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/AxiomaticTheory.html) for more details.*