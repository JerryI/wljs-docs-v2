...
```wolfram
Solve[x^4 - 1 == 0, x, Quartics -> True]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/Quartics.html) for more details.*