...
```wolfram
link = LinkOpen[LinkMode -> Loopback]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/Loopback.html) for more details.*