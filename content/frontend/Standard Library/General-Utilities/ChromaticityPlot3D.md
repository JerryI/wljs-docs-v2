...
Plot the sRGB color space in 3D:

```wolfram
ChromaticityPlot3D["sRGB"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/ChromaticityPlot3D.html) for more details.*