...
Conform images to same dimensions:

```wolfram
ConformImages[{img1, img2, img3}]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/ConformImages.html) for more details.*