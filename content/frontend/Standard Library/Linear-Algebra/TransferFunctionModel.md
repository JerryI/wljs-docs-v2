...
```wolfram
TransferFunctionModel[1/(s + 1), s]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/TransferFunctionModel.html) for more details.*