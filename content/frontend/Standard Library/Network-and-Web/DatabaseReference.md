...
Create a reference to a SQLite database:

```wolfram
DatabaseReference[File["mydata.db"]]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/DatabaseReference.html) for more details.*