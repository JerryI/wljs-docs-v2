...
```wolfram
ImageAdd[ExampleData[{"TestImage", "Lena"}], 0.2]
(* Image[...] *)
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/ImageAdd.html) for more details.*