...
```wolfram
HistogramPointDensity[RandomReal[1, 100]]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/HistogramPointDensity.html) for more details.*