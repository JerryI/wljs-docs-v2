...
```wolfram
ComplexStreamPlot[z^2, {z, -2 - 2 I, 2 + 2 I}]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/ComplexStreamPlot.html) for more details.*