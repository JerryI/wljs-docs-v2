...
```wolfram
TimelinePlot[{DateObject[{2020}], DateObject[{2021}], DateObject[{2022}]}]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/TimelinePlot.html) for more details.*