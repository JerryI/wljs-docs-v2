...
```wolfram
FormFunction[{"name" -> "String"}, #name &]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/FormFunction.html) for more details.*