...
```wolfram
PacletSiteUnregister["https://example.com/paclets"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/PacletSiteUnregister.html) for more details.*