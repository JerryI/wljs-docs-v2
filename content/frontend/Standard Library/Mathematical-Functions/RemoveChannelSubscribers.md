...
```wolfram
RemoveChannelSubscribers["myChannel"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/RemoveChannelSubscribers.html) for more details.*