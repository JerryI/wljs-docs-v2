...
```wolfram
audio = ExampleData[{"Audio", "Trumpet"}];
AudioSpectralMap[Abs, audio]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/AudioSpectralMap.html) for more details.*