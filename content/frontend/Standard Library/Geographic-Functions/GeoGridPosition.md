...
```wolfram
GeoGridPosition[{0, 0}, "Mercator"]
```

```wolfram
GeoGridPosition[Entity["City", {"Paris", "IleDeFrance", "France"}], "LambertConformalConic"]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/GeoGridPosition.html) for more details.*