...
```wolfram
GeoGridVector[GeoPosition[{40.7, -74.0}] -> {1, 0}, "Mercator"]
```

```wolfram
GeoVectorPlot[GeoGridVector[{{1, 1}, {-1, 1}}, "Mercator"]]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/GeoGridVector.html) for more details.*