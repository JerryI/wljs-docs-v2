...
```wolfram
MakeBoxes[x^2 + y, StandardForm]
```

*Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/MakeBoxes.html) for more details.*