...
#### `"TimeMarkers"`
Sets the time markers from the [Timeline](./Timeline)
...
- `"TimeMarkers"` - sets the time markers from the [Timeline](./Timeline)
...
### TimelinedAnimation
<Callout>
Read more at [Timeline](./Timeline) page
</Callout>
...
### Marker
A helper to wait or extract property from [Timeline](./Timeline) markers
