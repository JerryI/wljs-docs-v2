...
For example, `foo` **cannot call** [Input](./../Frontend%20IO/Input), [NotebookRead](./../Cells%20and%20Notebook/NotebookRead), [SystemInputDialog](./../Frontend%20IO/SystemDialogInput), `Rasterize`, `FrontFetch`, `WaitAll`, or similar blocking functions—which are explicitly marked as <small>blocking</small> in their documentation pages.
