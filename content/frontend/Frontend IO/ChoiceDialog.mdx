...
Blocking function. Avoid using it in timers like `SetTimeout`, external event handlers such as `InputButton` or `Button`, or within `AsyncFunction`. Use [ChoiceDialogAsync](./ChoiceDialogAsync) instead
</Callout>
