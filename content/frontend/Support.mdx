---
title: Support us
description: Support the open-source WLJS Notebook project and help fund its development, maintenance, documentation, and community resources.
---
...
- [**By Me A Coffee**](https://buymeacoffee.com/wljs)
...
<Callout>If you do not want to see a coffee icon, please, disable it from the settings of the app - see developer section</Callout>