...
Most plotting functions such as [ListPlot3D](../Plotting%20Functions/ListPlot3D) and others use this way showing 3D graphics.
...
Module[{
  ...
  },
    {
      ...
      Graphics3D[{
        ...
        }, VertexNormals->Offload[normals], "VertexFence"->True]
