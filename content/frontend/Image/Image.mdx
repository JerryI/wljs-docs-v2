...
```wolfram
EventHandler[Image[Table[RandomReal[], {20}, {20}]], {
	"click" -> Print
}]
```

### `HTMLView`
If you wrap any `Image` with [HTMLView](./../GUI/HTMLView), it will be automatically serialized to a file and embedded as native img element. This helps if you have many rasterized images in the notebook:
