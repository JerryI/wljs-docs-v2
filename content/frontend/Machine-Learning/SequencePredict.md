...
- `SequencePredict[…, seq, prop]` gives the specified property of the prediction associated with seq.
...
Please visit the official [Wolfram Language Reference](https://reference.wolfram.com/language/ref/SequencePredict.html) for more details.