...
One can directly render it using built-in LaTeX support in [Markdown](./../Cell-types/Markdown) cells or [LaTeX cells](./../Cell-types/Misc). Or alternatively via `CellView`
