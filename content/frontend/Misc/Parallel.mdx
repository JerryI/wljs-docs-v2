...
## `ParallelSubmitAsync`
Submits and expression for evaluation to any available parallel kernel and returns [Promise](../Misc/Promise) with the result
...
<Callout type="tip">
Launch parallel Kernels beforehand using `LaunchKernels[n_Integer]`
</Callout>
