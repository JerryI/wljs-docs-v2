...
## Options
### `"Window"`
By the default is uses [CurrentWindow](../Frontend-IO/CurrentWindow) from the current context. If the context is not available, you have to specify a window object explicitly.
