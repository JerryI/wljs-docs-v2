...
Normally one can append objects on existing plots using [FrontSubmit](../Frontend-IO/FrontSubmit), this wrapper allows to undo those action by disposing the created instances (even if they are nested). It does also support batch operations.
