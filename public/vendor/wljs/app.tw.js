// Source: https://github.com/WLJSTeam/web-components/blob/6012ef376c882540408545bdae2fb5c20a7710df/src/common/app.tw.js
// Local change: pin getBaseHref() so styles and modules use the same immutable revision.
function getBaseHref() {
    return 'https://cdn.jsdelivr.net/gh/WLJSTeam/web-components@6012ef376c882540408545bdae2fb5c20a7710df/src/'
}
...
class WLJSEditor extends HTMLElement {
  ...
  _mount() {
    ...
    try {
      ...
      this._instance = new ViewCtor({ updateSelection: () => {}, save: () => {}, element: host, noneditable: (!editable) }, decoded);
